export type StreamType = 'aggTrade' | 'trade' | 'kline' | 'miniTicker' | 'ticker' | 'bookTicker' | 'depth';
...
export type StreamPayload = AggTradeStreamPayload | TradeStreamPayload | KlineStreamPayload | MiniTickerStreamPayload | TickerStreamPayload | BookTickerStreamPayload | DepthStreamPayload;
